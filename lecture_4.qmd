...
-   R 래퍼 패키지: `plotly` package (<https://plotly.com/r/>)
...
-   세계지도를 위한 주요 투영법의 별명(alias) 및 PROJ 파라미터
...
|             | EPSG:3857     | 웹메르카토르 도법, 구글 맵스, 오픈스트리트맵에서 사용 |
|             | EPSG:7789     | ITRF2014                                              |
